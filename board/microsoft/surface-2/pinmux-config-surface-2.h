...
static struct pmux_pingrp_config tegra114_pinmux_common[] = {
	...
	DEFAULT_PINMUX(ULPI_DIR_PY1,           UARTD,       NORMAL, TRISTATE, INPUT),
	...
	DEFAULT_PINMUX(CLK2_OUT_PW5,           RSVD3,       NORMAL, NORMAL,   OUTPUT),
	...
	DEFAULT_PINMUX(CLK3_REQ_PEE1,          RSVD3,       DOWN,   TRISTATE, OUTPUT),
	DEFAULT_PINMUX(GMI_WP_N_PC7,           RSVD1,       UP,     NORMAL,   INPUT),
	DEFAULT_PINMUX(GMI_IORDY_PI5,          RSVD1,       NORMAL, NORMAL,   INPUT),
	...
	DEFAULT_PINMUX(GMI_CS4_N_PK2,          GMI,         DOWN,   NORMAL,   OUTPUT),
	DEFAULT_PINMUX(GMI_CS6_N_PI3,          NAND,        NORMAL, TRISTATE, INPUT),
	...
	DEFAULT_PINMUX(GMI_AD12_PH4,           RSVD3,       DOWN,   TRISTATE, OUTPUT),
	DEFAULT_PINMUX(GMI_AD13_PH5,           RSVD3,       DOWN,   TRISTATE, OUTPUT),
	...
	DEFAULT_PINMUX(GMI_A17_PB0,            RSVD1,       NORMAL, NORMAL,   INPUT),
	DEFAULT_PINMUX(GMI_A18_PB1,            RSVD1,       NORMAL, NORMAL,   INPUT),
	...
	DEFAULT_PINMUX(GMI_RST_N_PI4,          RSVD3,       NORMAL, NORMAL,   OUTPUT),
	...
	DEFAULT_PINMUX(PCC1,                   RSVD3,       DOWN,   TRISTATE, OUTPUT),
	...
	DEFAULT_PINMUX(PBB3,                   RSVD1,       NORMAL, NORMAL,   OUTPUT),
	DEFAULT_PINMUX(PBB4,                   RSVD1,       NORMAL, NORMAL,   OUTPUT),
	DEFAULT_PINMUX(PBB5,                   RSVD1,       NORMAL, NORMAL,   OUTPUT),
	DEFAULT_PINMUX(PBB6,                   RSVD1,       NORMAL, NORMAL,   INPUT),
	DEFAULT_PINMUX(PBB7,                   RSVD3,       NORMAL, NORMAL,   OUTPUT),
	...
	DEFAULT_PINMUX(KB_ROW0_PR0,            RSVD3,       NORMAL, NORMAL,   INPUT),
	DEFAULT_PINMUX(KB_ROW1_PR1,            KBC,         NORMAL, TRISTATE, INPUT),
	DEFAULT_PINMUX(KB_ROW2_PR2,            RSVD3,       NORMAL, NORMAL,   INPUT),
	DEFAULT_PINMUX(KB_ROW3_PR3,            RSVD2,       NORMAL, NORMAL,   OUTPUT),
	...
	DEFAULT_PINMUX(KB_ROW7_PR7,            RSVD1,       NORMAL, NORMAL,   OUTPUT),
	DEFAULT_PINMUX(KB_ROW8_PS0,            RSVD1,       NORMAL, NORMAL,   INPUT),
	DEFAULT_PINMUX(KB_ROW9_PS1,            RSVD2,       NORMAL, NORMAL,   OUTPUT),
	DEFAULT_PINMUX(KB_ROW10_PS2,           RSVD2,       NORMAL, NORMAL,   INPUT),
	DEFAULT_PINMUX(KB_COL0_PQ0,            KBC,         NORMAL, NORMAL,   INPUT),
	DEFAULT_PINMUX(KB_COL1_PQ1,            RSVD1,       NORMAL, NORMAL,   INPUT),
	DEFAULT_PINMUX(KB_COL2_PQ2,            RSVD3,       NORMAL, NORMAL,   INPUT),
	...
	DEFAULT_PINMUX(KB_COL6_PQ6,            RSVD3,       NORMAL, NORMAL,   INPUT),
	DEFAULT_PINMUX(KB_COL7_PQ7,            RSVD3,       NORMAL, NORMAL,   INPUT),
	DEFAULT_PINMUX(CLK_32K_OUT_PA0,        BLINK,       NORMAL, NORMAL,   OUTPUT),
	DEFAULT_PINMUX(SYS_CLK_REQ_PZ5,        RSVD3,       NORMAL, NORMAL,   INPUT),
	...
	DEFAULT_PINMUX(OWR,                    RSVD3,       DOWN,   TRISTATE, OUTPUT),
	...
	DEFAULT_PINMUX(SPDIF_IN_PK6,           RSVD3,       NORMAL, NORMAL,   OUTPUT),
	DEFAULT_PINMUX(SPDIF_OUT_PK5,          RSVD3,       NORMAL, NORMAL,   OUTPUT),
	...
	DEFAULT_PINMUX(DVFS_PWM_PX0,           RSVD3,       NORMAL, NORMAL,   OUTPUT),
	DEFAULT_PINMUX(GPIO_X1_AUD_PX1,        RSVD3,       DOWN,   TRISTATE, OUTPUT),
	DEFAULT_PINMUX(GPIO_X3_AUD_PX3,        RSVD3,       UP,     NORMAL,   INPUT),
	DEFAULT_PINMUX(DVFS_CLK_PX2,           RSVD3,       NORMAL, NORMAL,   OUTPUT),
	DEFAULT_PINMUX(GPIO_X4_AUD_PX4,        RSVD1,       DOWN,   TRISTATE, OUTPUT),
	DEFAULT_PINMUX(GPIO_X5_AUD_PX5,        RSVD1,       NORMAL, TRISTATE, INPUT),
	DEFAULT_PINMUX(GPIO_X6_AUD_PX6,        SPI6,        NORMAL, NORMAL,   OUTPUT),
	...
	DEFAULT_PINMUX(USB_VBUS_EN0_PN4,       RSVD3,       NORMAL, NORMAL,   OUTPUT),
	DEFAULT_PINMUX(USB_VBUS_EN1_PN5,       RSVD3,       DOWN,   TRISTATE, OUTPUT),
	DEFAULT_PINMUX(SDMMC3_CLK_LB_IN_PEE5,  SDMMC3,      NORMAL, NORMAL,   OUTPUT),
