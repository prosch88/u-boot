...
static struct pmux_pingrp_config tegra3_pinmux_common[] = {
	...
	DEFAULT_PINMUX(SDMMC3_DAT7_PD4, SDMMC3, UP, NORMAL, OUTPUT),
	...
	DEFAULT_PINMUX(KB_ROW13_PS5, KBC, DOWN, NORMAL, INPUT), //windows button active high
	DEFAULT_PINMUX(KB_ROW14_PS6, KBC, UP, NORMAL, INPUT),//volume down active low
	DEFAULT_PINMUX(KB_ROW15_PS7, KBC, UP, NORMAL, INPUT),//volume up active low
	...
	DEFAULT_PINMUX(PV0, RSVD1, DOWN, NORMAL, INPUT), //power button active high
	...
	DEFAULT_PINMUX(SDMMC3_DAT4_PD1, SDMMC3, UP, NORMAL, OUTPUT),
