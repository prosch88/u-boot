...
static struct pmux_pingrp_config tegra114_pinmux_common[] = {
	...
	DEFAULT_PINMUX(DVFS_PWM_PX0,           RSVD4,       NORMAL, NORMAL,   OUTPUT),
	DEFAULT_PINMUX(GPIO_X1_AUD_PX1,        RSVD4,       DOWN,   TRISTATE, OUTPUT),
	...
	DEFAULT_PINMUX(USB_VBUS_EN0_PN4,       RSVD4,       NORMAL, NORMAL,   OUTPUT),
	DEFAULT_PINMUX(USB_VBUS_EN1_PN5,       RSVD4,       DOWN,   TRISTATE, OUTPUT),
